  ...
  if (error || !metrics) {
    return (
      <div className="space-y-6">
        ...
        <button
          onClick={refetch}
          className="px-4 py-2 rounded-lg bg-gradient-to-r from-primary to-secondary text-[#0f2e25] font-semibold hover:from-[#28A428] hover:to-[#e6e600] transition-all shadow-sm"
        >
          Retry
        </button>
      </div>
