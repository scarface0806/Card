  ...
  return (
    <section className="relative py-20 md:py-32 bg-dark-bg overflow-hidden">
      ...
      <div className="absolute inset-0 -z-10">
        <div className="absolute bottom-1/3 left-1/4 w-80 h-80 bg-primary/10 rounded-full blur-3xl opacity-50" />
      </div>
              ...
              >
                {plan.highlighted && (
                  <div className="absolute -top-4 left-1/2 transform -translate-x-1/2">
                    <span className="bg-gradient-to-r from-primary to-secondary text-[#03170f] text-xs font-bold px-4 py-1 rounded-full">
                      MOST POPULAR
                    </span>
                  </div>
                )}
